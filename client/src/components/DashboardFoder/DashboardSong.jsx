    ...
    <div className="w-full p-4 flex items-center justify-center flex-col">
      <div className="w-full flex justify-center items-center gap-20">
        <NavLink to={"/dashboard/newSong"} 
          className={"flex items-center justify-center px-4 py-3 border rounded-md border-gray-500 hover:shadow-md cursor-pointer"}>
          <IoAdd />
        </NavLink>
      ...
      <div className='relative w-full my-4 p-4 border border-gray-300 rounded-md'>
        <div className='absolute top-4 left-4'>
            <p className='text-xl font-bold' >
              ...
              {allSongs && allSongs.length > 0 ? allSongs.length : 0}
            </p>
        </div>
